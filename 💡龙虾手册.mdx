...
![image-20260412133620147](💡龙虾手册.assets/image-20260412133620147.png)

> #### 配置OpenClaw
>
> 1. 在[轻量应用服务器-控制台](https://swasnext.console.aliyun.com/servers)，单击服务器卡片中的实例ID，在**服务器概览**页面单击**应用详情**页签。
>
>    ![image-20260412134523227](💡龙虾手册.assets/image-20260412134523227.png)
>
...
>    - **手动输入**
>
>      单击按钮切换至手动输入，输入百炼API Key并选择该API Key对应地域，单击**下一步**。![image](💡龙虾手册.assets/p1052681.png)
>
...
>
> ![image-20260412140553361](💡龙虾手册.assets/image-20260412140553361.png)
...
>
>    ![image](💡龙虾手册.assets/p1055077.png)
>
> 5. 配置事件订阅。
>
...
>
>    ![image-20260412141240593](💡龙虾手册.assets/image-20260412141240593.png)
...
>
>    <img src="💡龙虾手册.assets/p1054243.png" alt="image" style="zoom:50%;" />
>
> 2. 在WebUI页面输入`openclaw pairing approve feishu 配对码`完成配对。
>
>    > 配对码是上一步机器人回复的配对码。
>
>    ![image](💡龙虾手册.assets/p1054248.png)
...
>    ```
>
>    ![image](💡龙虾手册.assets/p1058908.png)
>
> 3. 完成配对。
>
...
![image-20260412143438624](💡龙虾手册.assets/image-20260412143438624.png)
...
![image-20260412143558389](💡龙虾手册.assets/image-20260412143558389.png)
